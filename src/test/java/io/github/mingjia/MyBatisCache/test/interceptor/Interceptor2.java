...
public class Interceptor2 implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        System.out.println("Interceptor2 拦截方法:" + method);
        System.out.println("Interceptor2 拦截sql:" + sql);

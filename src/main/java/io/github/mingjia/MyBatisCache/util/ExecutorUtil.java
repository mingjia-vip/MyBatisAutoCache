...
import io.github.mingjia.MyBatisCache.CacheException;
...
public class ExecutorUtil {
    ...
    static {
        try {
            ...
            throw new CacheException("获取 BoundSql 属性 additionalParameters 失败: " + e, e);
        }
    }
    ...
    public static Map<String, Object> getAdditionalParameter(BoundSql boundSql) {
        try {
            ...
            throw new CacheException("获取 BoundSql 属性值 additionalParameters 失败: " + e, e);
        }
    }
}
